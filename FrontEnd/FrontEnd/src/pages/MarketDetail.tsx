    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6">
            ...
            <div className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur">
                <h2 className="text-lg font-semibold mb-4 text-white">Supply Stablecoins</h2>

                {!user ? (
                    <p className="text-gray-400">Connect your wallet to supply liquidity.</p>
                ) : (
                    <div className="space-y-4">

                        <div>
                            <p className="text-sm text-gray-400">Your supplied balance</p>
                            <p className="text-white font-medium">
                                {lenderBalance ? Number(lenderBalance) / 1e18 : 0}
                            </p>
                        </div>
                        ...
                        {isConfirming && (
                            <p className="text-yellow-400 text-sm">Transaction confirming...</p>
                        )}
